...
<script type="text/javascript">
    ...
    """),_display_(/*39.6*/for(conferenceList <- confereces) yield /*39.39*/{_display_(Seq[Any](format.raw/*39.40*/("""
        """),format.raw/*40.9*/("""L.marker(["""),_display_(/*40.20*/conferenceList/*40.34*/.getX()),format.raw/*40.41*/(""", """),_display_(/*40.44*/conferenceList/*40.58*/.getY()),format.raw/*40.65*/("""]).addTo(mymap).bindPopup("<b>"""),_display_(/*40.96*/conferenceList/*40.110*/.getName()),format.raw/*40.120*/("""</b>").openPopup();
    """)))}),format.raw/*41.6*/("""
